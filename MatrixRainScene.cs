...
namespace advent
{
    public class MatrixRainScene : ISpecialScene
    {
        ...
        private readonly List<RainColumn> columns = new List<RainColumn>();
        ...
        public void Elapsed(TimeSpan timeSpan)
        {
            ...
            for (var i = 0; i < columns.Count; i++)
            {
                ...
                if (column.HeadY - column.TrailLength > Height + 1)
                {
                    columns[i] = CreateColumn(column.X);
                }
            }
        }
        ...
        public void Draw(Image<Rgba32> img)
        {
            ...
            for (var i = 0; i < columns.Count; i++)
            {
                ...
                {
                    img[column.X, headY] = new Rgba32(190, 255, 200);
                }
            }
        }
